...
export async function fetchDataFromApis() {
  ...
  const [response1, response2, response3, response4, response5, response6] = await Promise.all([
    ...
    fetch(
      "https://data.census.gov/api/profile/content/topic?g=050XX00US19013&infoSection=Older%20Population"
    ),
    ...
    fetch(
      "https://api.census.gov/data/2021/cbp?get=group(CB2100CBP)&NAICS2017=pseudo(N0200.00)&ucgid=0500000US19013"
    ),
    fetch(
      "https://api.census.gov/data/2022/acs/acs1/subject?get=group(S1901)&ucgid=0500000US19013"
    ),
  ]);
...
export const handleButtonClick = async (
  ...
  const fetchChartData = async () => {
    ...
    const apiResponse = await fetch(
      "https://data.census.gov/api/profile/content/topic?g=050XX00US19013&infoSection=Language%20Spoken%20at%20Home"
    );
