...
export const FloodMenu = ({ isFloodLayerSelected, toggleMenu, handleLayerSelectChangeFlood }) => {
        ...
        isFloodLayerSelected && (
            ...
            >
                ...
                <div style={{ marginTop: '30px' }}>
                    <h3 style={{ backgroundColor: '#4A90E2', color: 'white', padding: '5px', borderRadius: '4px' }}>WATERLOO</h3>
                    <p><strong>River:</strong> Cedar River</p>
                    <p><strong>Gauge ID:</strong> 05464000 (reference)</p>
                    <p><strong>Flood Level:</strong> 13 ft</p>
                </div>
                ...
                <div style={{ marginTop: '20px' }}>
                    <h4 style={{ backgroundColor: '#8CC152', color: 'white', padding: '5px', borderRadius: '4px' }}>Flood Map Controller</h4>
